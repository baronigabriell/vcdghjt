...
<body>
    ...
    <main id="main-inicial">
        <div class="box" id="box-tabuleiro">
            <h1>Tabuleiro</h1>
        ...
        <div class="box" id="box-personagens">
            <h1>Personagens</h1>
...
hamburger.addEventListener('click', () => {
  // Adiciona ou remove a classe 'active' para o menu e o hamburger
