...
<body>
    ...
    <main id="main-dado">
        ...
        <div class="carta <?php echo $bloqueado ? 'bloqueado' : ''; ?>"
            <?php if (!$bloqueado): ?>onclick="window.location.href='quizfase4.php'" <?php endif; ?>>
        </div>
    ...
    <div style="display: inline;">
        <button id="fase3" onclick="redirecionarPaginaFase3()">Voltar para a 3ª fase</button>
        <button id="finalizar" onclick="redirecionarPaginaFinalizar()">Finalizar</button>
    </div>
    <?php
    ...
    <script>
        ...
        function redirecionarPaginaQuiz() {
            window.location.href = "quizfase4.php";
        }

        function redirecionarPaginaFinalizar() {
            window.location.href = "final.php";
        }

        function redirecionarPaginaFase3() {
