...
<body>
    ...
    <main id="main-dado">
        ...
        <div class="carta <?php echo $bloqueado ? 'bloqueado' : ''; ?>"
            <?php if (!$bloqueado): ?>onclick="window.location.href='quizfase2.php'" <?php endif; ?>>
        </div>
    ...
    <div style="display: inline;">
        <button id="fase1" onclick="redirecionarPaginaFase1()">Voltar para a 1ª fase</button>
        <button id="fase3" onclick="redirecionarPaginaFase3()">Ir para a 3ª fase</button>
    </div>
    <?php
    ...
    <script>
        ...
        function redirecionarPaginaQuiz() {
            window.location.href = "quizfase2.php";
        }
        ...
        function redirecionarPaginaFase1() {
